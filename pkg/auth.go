...
func Auth(prefix, msg, sk, pk, cert, mpk []byte, pp ZskPP) ([]byte, []byte, marlin.Proof, marlin.VerifyKey) {
...
// marlin.
func Verify(prefix, msg []byte, pp ZskPP, proof marlin.Proof, vk marlin.VerifyKey) bool {
	return marlin.ZebraLancerVerifyProof(
		pp.tag1, pp.tag2, proof, vk,
	)
}
