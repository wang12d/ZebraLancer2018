...
func Auth(prefix, msg, sk, pk, cert, mpk []byte) (pkg.Proof, marlin.VerifyKey) {
	...
	return pkg.Proof{TagPrefix: t1, TagPrefixMsg: t2, ZSKProof: proof}, vk
}

// Verify using the common knowledge and public input to verify proof generated by
// marlin.
func Verify(prefix, msg, mpk []byte, proof pkg.Proof, vk marlin.VerifyKey) bool {
	return marlin.ZebraLancerVerifyProof(
		prefix, msg, mpk, proof.TagPrefix, proof.TagPrefixMsg, proof.ZSKProof, vk,
	)
}
